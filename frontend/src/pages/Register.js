        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full bg-transparent border border-slate-700 rounded-xl p-3 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-purple-500 outline-none transition"
